<?php
	...
	function disptopics($cid, $scid) {
		...
		if (mysqli_num_rows($select) != 0) {
			...
			echo "<p>This category has no topics yet!  <a href='/forum/newtopic.php?cid=".$cid."&scid=".$scid."'><strong>
				 Click here to add the very first topic like a boss!</strong></a></p>";
		}
	}
...
// to count the numbers of views
	...
	function replylink($cid, $scid, $tid) {
		echo "<p><a href='/forum/replyto.php?cid=".$cid."&scid=".$scid."&tid=".$tid."'><Strong>Click here to reply to this post</Strong></a></p>";
	}
